...
class MedicineController extends Controller
{
    ...
    {
        $query = Medicine::query()->orderBy('created_at', 'desc');
    ...
    {
        $medicine = Medicine::with('attachments', 'category', 'supplier')->where('uuid', $uuid)->firstOrFail();

        return Inertia::render('Dashboard/Medicine/Details', [
            'medicine' => $medicine,
        ]);
    }
    ...
    public function template()
    {
        ...
        Log::info('Gerando template Excel para medicamentos.');
